...
class WSConsumerSettingsComponent {
    ...
    val panel: JPanel = FormBuilder.createFormBuilder()
        ...
        .addLabeledComponent(JBLabel("WSHeaders (Container) Annotation FQN:"), wsHeadersAnnotationField, 1, false)
        .addLabeledComponent(JBLabel("InternalApi Annotation FQN:"), internalApiAnnotationField, 1, false) // New
        .addSeparator()
