...
class WSConsumerSettingsComponent {
  ...
  private val validatePropertyAnnotationsCheckbox =
    JBCheckBox("Validate @Property annotations on setters and getters")
  ...
  private val wsHeaderAnnotationField = JBTextField()
  private val wsHeadersAnnotationField = JBTextField()
  private val internalApiAnnotationField = JBTextField() // New
  ...
  val panel: JPanel =
    FormBuilder.createFormBuilder()
      ...
      .addLabeledComponent(
        JBLabel("WSConsumer Annotation FQN:"),
        wsConsumerAnnotationField,
        1,
        false,
      )
      .addLabeledComponent(
        JBLabel("WebserviceConsumer Interface FQN:"),
        webserviceConsumerField,
        1,
        false,
      )
      .addLabeledComponent(
        JBLabel("PearlWebserviceConsumer class FQN:"),
        pearlWebserviceConsumerField,
        1,
        false,
      )
      ...
      .addLabeledComponent(
        JBLabel("HttpRequest Annotation FQN:"),
        httpRequestAnnotationField,
        1,
        false,
      ) // Add new field
      .addLabeledComponent(JBLabel("WSHeader Annotation FQN:"), wsHeaderAnnotationField, 1, false)
      .addLabeledComponent(
        JBLabel("WSHeaders (Container) Annotation FQN:"),
        wsHeadersAnnotationField,
        1,
        false,
      )
      .addLabeledComponent(
        JBLabel("InternalApi Annotation FQN:"),
        internalApiAnnotationField,
        1,
        false,
      ) // New
      .addSeparator()
  ...
  var internalApiAnnotationFqn: String // New
    get() = internalApiAnnotationField.text
    set(value) {
      internalApiAnnotationField.text = value
    }
}
