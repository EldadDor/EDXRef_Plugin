...
import com.intellij.psi.util.PsiTreeUtil // For finding method calls more reliably
            ...
            psiFile.accept(object : JavaRecursiveElementVisitor() {
                override fun visitMethodCallExpression(call: PsiMethodCallExpression) {
                    ...
                    if (methodExpr.referenceName == getQueryUtilsMethodName(psiFile.project)) {
                        ...
                        if (qualifierText == "queryUtils" || qualifierText == getQueryUtilsFqn(psiFile.project)) { // Example check
                            ...
                            if (args.size == 1 && args[0] is PsiLiteralExpression) {
                                ...
                                if (!queryId.isNullOrBlank()) {
                                    ...
                                    log.debug("Indexer found potential usage: ID='$queryId' in ${inputData.file.name}")
