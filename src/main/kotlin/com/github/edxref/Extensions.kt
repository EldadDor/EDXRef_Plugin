...
fun KtClass.isEnabledClass(enabledPackages: Set<String>): Boolean {
  ...
  return enabledPackages.any {
    fqName?.parent().toString().contains(it)
  } // we use contains to check for inner class
}

/**
 * @return list of [KtParameter] This method returns all the params of the data class for which the
 *   'Gson SerializedName' annotation is missing.
 */
...
/**
 * @return list of [KtParameter] This method returns all the params of the data class for which the
 *   'Moshi Json' annotation is missing.
 */
...
/**
 * @return list of [KtParameter] This method returns all the params of the data class for which the
 *   'Kotlinx SerialName' annotation is missing.
 */
...
/**
 * @param project This method adds the missing 'Gson SerializedName' annotation to all params of the
 *   data class.
 */
fun List<KtParameter>.addSerializedNameAnnotations(project: Project) {
  this.forEach { param -> param.addSerializedNameAnnotation(project = project) }
}

/**
 * @param project This method adds the missing 'Gson SerializedName' annotation to the current param
 *   of the data class.
 */
...
/**
 * @param project This method adds the missing 'Moshi Json' annotation to all params of the data
 *   class.
 */
fun List<KtParameter>.addJsonAnnotations(project: Project) {
  this.forEach { param -> param.addJsonAnnotation(project = project) }
}

/**
 * @param project This method adds the missing 'Moshi Json' annotation to the current param of the
 *   data class.
 */
...
/**
 * @param project This method adds the missing 'Kotlinx SerialName' annotation to all params of the
 *   data class.
 */
fun List<KtParameter>.addSerialNameAnnotations(project: Project) {
  this.forEach { param -> param.addSerialNameAnnotation(project = project) }
}

/**
 * @param project This method adds the missing 'Kotlinx SerialName' annotation to the current param
 *   of the data class.
 */
...
/**
 * Taken from [org.jetbrains.kotlin.idea.util.addAnnotation] Modified to include named param for
 * 'Moshi Json' annotation.
 */
