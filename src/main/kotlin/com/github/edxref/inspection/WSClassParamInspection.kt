...
private fun getPearlWebserviceConsumerFqn(project: Project) =
  getSettings(project).pearlWebserviceConsumerFqn.ifBlank {
    "com.github.edxref.annotations.PearlWebserviceConsumer"
  }

private fun getHttpRequestAnnotationFqn(project: Project) =
  getSettings(project).httpRequestAnnotationFqn.ifBlank {
    "com.github.edxref.annotations.HttpRequest"
  }
  ...
  fun runClassSpecificValidations(
    ...
    if (psiClass.getAnnotation(httpRequestFqn) == null) {
      logIfEnabled(
        project,
        log,
        "ERROR: Class ${psiClass.name} is missing @${httpRequestFqn.substringAfterLast('.')}",
      )
...
// --- Java Inspection ---
class WSClassParamJavaInspection :
  AbstractBaseJavaLocalInspectionTool(), WSClassParamInspectionLogic {
  ...
  override fun buildVisitor(
    ...
    return object : JavaElementVisitor() {
      override fun visitClass(psiClass: PsiClass) {
        ...
        // Use psiClass.allMethods if inherited setters should be included, otherwise
        // psiClass.methods
...
// --- Kotlin Inspection ---
class WSClassParamKotlinInspection :
  AbstractBaseUastLocalInspectionTool(), WSClassParamInspectionLogic {
