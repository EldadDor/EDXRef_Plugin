...
import com.github.edxref.settings.WSConsumerSettings.Companion.getWSConsumerSettings // Adjust import
 ...
 * Key: FQN of the @InternalApi annotation (retrieved from settings).
 * Value: Boolean (true if found, could be more complex like list of offsets).
 */
class InternalApiIndex : ScalarIndexExtension<String>() {
    ...
    override fun getIndexer(): DataIndexer<String, Void, FileContent> {
        return DataIndexer { inputData ->
            ...
            val internalApiFqn = project.getWSConsumerSettings().internalApiAnnotationFqn.ifBlank { return@DataIndexer emptyMap() }
            ...
            if (file is PsiJavaFile) {
                ...
                file.declarations.filterIsInstance<KtClass>().forEach { ktClass ->
                    ...
                    if (ktClass.annotationEntries.any { it.shortName?.asString() == internalApiFqn.substringAfterLast('.') }) {
                        found = true
                        return@forEach
                    }
